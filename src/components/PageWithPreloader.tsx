...
export default function PageWithPreloader({ initialData }: PageWithPreloaderProps) {
  ...
  return (
    <>
      ...
      {!showPreloader && (
        <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 transition-opacity duration-500 ${contentVisible ? 'opacity-100' : 'opacity-0'}`}>
          {/* Top Bar */}
